...
OWNER_ID = int(getenv("OWNER_ID", "6204193689"))
MONGO_URL = getenv("MONGO_URL", None)
SUPPORT_GRP = getenv("SUPPORT_GRP", "II_DOSTI_II")
UPDATE_CHNL = getenv("UPDATE_CHNL", "Want_To_Know_Mee")
OWNER_USERNAME = getenv("OWNER_USERNAME", "Want_To_Know_Mee")
